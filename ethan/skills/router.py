...
不影响主流程。依赖 onnxruntime + transformers（pip install 'ethan-agent[router]'）。
"""
...
class _Encoder:
    ...
    def encode(self, texts):
        ...
        if isinstance(texts, str):
            texts = [texts]
        batch = self._tok(texts, padding=True, truncation=True, max_length=_MAX_LENGTH, return_tensors="np")
