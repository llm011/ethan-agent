...
- 大纲里每页写明：action title、2-4 个支撑要点（含具体数字/机制）、页面角色（总览/细节①/对比/结论）、锚点编号。
...
- **排版必读 `references/layout-guide.md`**：咨询式页面骨架（kicker + 观点标题 + 导航点 + 2-4 区块 + takeaway 栏）、信息密度标准（图为主字为注、每页 80-150 字、bullet 必含数字/机制/对比）、总览↔细节锚定规则。
